...
public class SecurityConfig {
    ...
    @Autowired
    private SecurityAuditLogFilter securityAuditLogFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterAfter(securityAuditLogFilter, UsernamePasswordAuthenticationFilter.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.Arrays.asList(
                ...
                "https://asir.javiergimenez.es:9145", // VPS Secure Port
                "https://localhost:9145", // VPS Secure Localhost
                "https://asir.javiergimenez.es")); // VPS Secure Host
